...
class AddList extends Component {
  ...
  render() {
    return (
      <div className="list_add cell small-3">
        <form  onSubmit={this.createList}>
            <input type="text" name="listName" value={this.state.value} onChange={this.handleChange} size="30" placeholder="Add a list..."/>
            <button className="list_button-submit success button small" type="submit">Save</button>
            <button className="list_x" onClick={this.cancelAdd}>
